...
Definition equiv_between_recur_sem {X Y: Type} 
                                   (ceval_X: com -> X)
                                   (ceval_Y: com -> Y)
                                   (RXY: X -> Y -> Prop) : Prop :=
...
Theorem equiv_between_normal_time:
  equiv_between_recur_sem BinRel.ceval StepCnt.ceval Bin_Step_Equiv.
Proof.
  unfold equiv_between_recur_sem, Bin_Step_Equiv.
