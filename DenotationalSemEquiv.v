...
Theorem Bin_Step_skip_sem_equiv:
  Bin_Ter_skip_sem_equiv (BinRel.sem) (StepCnt.sem).
Proof.
...
Theorem Bin_Step_asgn_sem_equiv:
  Bin_Ter_asgn_sem_equiv (BinRel.sem) (StepCnt.sem).
Proof.
...
Theorem Bin_Step_seq_sem_equiv:
  Bin_Ter_seq_sem_equiv (BinRel.sem) (StepCnt.sem).
Proof.
...
Theorem Bin_Step_if_sem_equiv:
  Bin_Ter_if_sem_equiv (BinRel.sem) (StepCnt.sem).
Proof.
...
Theorem Bin_Step_loop_sem_equiv:
  Bin_Ter_loop_sem_equiv (BinRel.sem) (StepCnt.sem).
Proof.
...
Theorem Bin_Trace_skip_sem_equiv:
  Bin_Ter_skip_sem_equiv (BinRel.sem) (Trace.sem).
Proof.
  unfold Bin_Ter_skip_sem_equiv. simpl.
  unfold Bin_Ter_sem_equiv. intros.
...
Theorem Bin_Trace_asgn_sem_equiv:
  Bin_Ter_asgn_sem_equiv (BinRel.sem) (Trace.sem).
Proof.
  unfold Bin_Ter_asgn_sem_equiv. simpl.
  unfold Bin_Ter_sem_equiv. intros.
...
Theorem Bin_Trace_seq_sem_equiv:
  Bin_Ter_seq_sem_equiv (BinRel.sem) (Trace.sem).
Proof.
  unfold Bin_Ter_seq_sem_equiv. simpl.
  unfold Bin_Ter_sem_equiv. intros.
...
Theorem Bin_Trace_if_sem_equiv:
  Bin_Ter_if_sem_equiv (BinRel.sem) (Trace.sem).
Proof.
  unfold Bin_Ter_if_sem_equiv. simpl.
  unfold Bin_Ter_sem_equiv. intros.
...
Theorem Bin_Trace_loop_sem_equiv:
  Bin_Ter_loop_sem_equiv (BinRel.sem) (Trace.sem).
Proof.
  unfold Bin_Ter_loop_sem_equiv. simpl.
  unfold Bin_Ter_sem_equiv. intros.
  unfold BinRel.loop_sem, Relation_Operators.omega_union.
...
Proof.
  apply (command_equiv__sem_equiv Z BinRel.sem StepCnt.sem
    Bin_Step_skip_sem_equiv Bin_Step_asgn_sem_equiv
    Bin_Step_seq_sem_equiv  Bin_Step_if_sem_equiv
...
Proof.
  apply (command_equiv__sem_equiv (list state) BinRel.sem Trace.sem
    Bin_Trace_skip_sem_equiv Bin_Trace_asgn_sem_equiv
    Bin_Trace_seq_sem_equiv  Bin_Trace_if_sem_equiv
